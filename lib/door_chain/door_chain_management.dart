  ...
  HTTPget(String username)async{
    try{
      ...
      HttpClientRequest request = await httpClient.getUrl(
          Uri(scheme: "http",path: "/app/getchain",host: "192.168.1.102",port: 5000,queryParameters: {
            "username":username,
          })
      );
  ...
  HTTPpost(String username)async{
    try{
      ...
      if(datalist.length==0){
        uri = Uri(scheme: "http",path: "/app/updatachain",host: "192.168.1.102",port: 5000,queryParameters: {
